...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>DoDragDrop/DoDragDrop.ahk at master · AHK-just-me/DoDragDrop · GitHub</title>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="25913217:0F6B:1A35CB8B:561554B5" name="octolytics-dimension-request_id" />
...
<meta content="Q9fw/k3mU+Vh5LkeRm8/2PWNkDLTycKmswnaud7mj6piaEotuKxFKRW5LPHr1bHUN9VYsh15QnTxS9t6xDVHKw==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2FAHK-just-me%2FDoDragDrop%2Fblob%2Fmaster%2Fsources%2FDoDragDrop.ahk" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<div class="clone-options text-small">You can clone with
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="7648e1d9d4774d311d1cc6f9c8180b70e2d4f906" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="8oa+ZahSGrZnHz7gKrGosOKFDbolvza73u8rsZAfh2yzT1FHioG1NNG4ZrP7QJ6tQVDtdTA4urfab1msvSq0TQ==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="7648e1d9d4774d311d1cc6f9c8180b70e2d4f906" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="k9530Tfim8g1dqZDwu7wtZF9HtJGG+UsjVD6/oxNq6+2raHUQ4pNXHnJdRYdW6w08pXKLFLTs5j1v3llFQ2a6A==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
...
<a href="/AHK-just-me/DoDragDrop/blob/67075c3e2468135f3b413bbf2b7bce06f65d08e7/sources/DoDragDrop.ahk" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:1d4e4e76fd56eeb2eee2f3fbc2030d6f -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/AHK-just-me/DoDragDrop/blob/master/sources/DoDragDrop.ahk"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<div class="file">
  ...
  <div class="file-actions">
    ...
    <div class="btn-group">
      <a href="/AHK-just-me/DoDragDrop/raw/master/sources/DoDragDrop.ahk" class="btn btn-sm " id="raw-url">Raw</a>
        <a href="/AHK-just-me/DoDragDrop/blame/master/sources/DoDragDrop.ahk" class="btn btn-sm js-update-url-with-hash">Blame</a>
      <a href="/AHK-just-me/DoDragDrop/commits/master/sources/DoDragDrop.ahk" class="btn btn-sm " rel="nofollow">History</a>
    </div>
  ...
  <div class="blob-wrapper data type-autohotkey">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-c">; DoDragDrop -&gt; msdn.microsoft.com/en-us/library/ms678486(v=vs.85).aspx</span></td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-c">; Requires: IDropSource.ahk</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC5" class="blob-code blob-code-inner js-file-line"><span class="pl-c">; Carries out an OLE drag and drop operation using the current contents of the clipboard.</span></td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-c">; Return values:</span></td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-c">;     If the data have been dropped successfully, the functions returns the performed drop operation (i.e. 1 for</span></td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code blob-code-inner js-file-line"><span class="pl-c">;     DROPEFFECT_COPY or 2 for DROPEFFECT_MOVE). In all other cases the function returns 0.</span></td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code blob-code-inner js-file-line"><span class="pl-c">;     If DROPEFFECT_MOVE is returned, the drag source should remove the data.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC11" class="blob-code blob-code-inner js-file-line"><span class="pl-en">DoDragDrop</span>() {</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line">   <span class="pl-c">; DRAGDROP_S_DROP = 0x40100</span></td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code blob-code-inner js-file-line">   <span class="pl-k">Static</span> DropEffects <span class="pl-k">:=</span> <span class="pl-c1">0x03</span> <span class="pl-c">; DROPEFFECT_COPY | DROPEFFECT_MOVE</span></td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code blob-code-inner js-file-line">   IDS <span class="pl-k">:=</span> IDropSource_Create()</td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code blob-code-inner js-file-line">   <span class="pl-k">If</span> <span class="pl-k">!</span><span class="pl-c1">DllCall</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Ole32.dll\OleGetClipboard<span class="pl-pds">&quot;</span></span>, <span class="pl-s"><span class="pl-pds">&quot;</span>PtrP<span class="pl-pds">&quot;</span></span>, pDataObj, <span class="pl-s"><span class="pl-pds">&quot;</span>UInt<span class="pl-pds">&quot;</span></span>) {</td>
      </tr>
      <tr>
        <td id="L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-code blob-code-inner js-file-line">      RC <span class="pl-k">:=</span> <span class="pl-c1">DllCall</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Ole32.dll\DoDragDrop<span class="pl-pds">&quot;</span></span>,<span class="pl-s"><span class="pl-pds">&quot;</span>Ptr<span class="pl-pds">&quot;</span></span>, pDataObj, <span class="pl-s"><span class="pl-pds">&quot;</span>Ptr<span class="pl-pds">&quot;</span></span>, IDS, <span class="pl-s"><span class="pl-pds">&quot;</span>UInt<span class="pl-pds">&quot;</span></span>, DropEffects, <span class="pl-s"><span class="pl-pds">&quot;</span>PtrP<span class="pl-pds">&quot;</span></span>, Effect, <span class="pl-s"><span class="pl-pds">&quot;</span>Int<span class="pl-pds">&quot;</span></span>)</td>
      </tr>
      <tr>
        <td id="L17" class="blob-num js-line-number" data-line-number="17"></td>
        <td id="LC17" class="blob-code blob-code-inner js-file-line">      <span class="pl-k">If</span> IDataObject_GetPerformedDropEffect(pDataObj, <span class="pl-k">ByRef</span> PerformedDropEffect)</td>
      </tr>
      <tr>
        <td id="L18" class="blob-num js-line-number" data-line-number="18"></td>
        <td id="LC18" class="blob-code blob-code-inner js-file-line">         Effect <span class="pl-k">:=</span> PerformedDropEffect</td>
      </tr>
      <tr>
        <td id="L19" class="blob-num js-line-number" data-line-number="19"></td>
        <td id="LC19" class="blob-code blob-code-inner js-file-line">      ObjRelease(pDataObj)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC21" class="blob-code blob-code-inner js-file-line">   IDropSource_Free(IDS)</td>
      </tr>
      <tr>
        <td id="L22" class="blob-num js-line-number" data-line-number="22"></td>
        <td id="LC22" class="blob-code blob-code-inner js-file-line">   <span class="pl-k">Return</span> (RC <span class="pl-k">=</span> <span class="pl-c1">0x40100</span> ? Effect : <span class="pl-c1">0</span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC25" class="blob-code blob-code-inner js-file-line"><span class="pl-k">#Include<span class="pl-s"> *i %A_ScriptDir%\IDropSource.ahk</span></span></td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04265s from github-fe117-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
