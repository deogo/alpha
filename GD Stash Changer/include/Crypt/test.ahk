...
;~ p := "C:\Users\Deo\Documents\My Games\Grim Dawn\save"
;~ Loop,%p%\*.bak*,0,0	;getting files only
;~ {
  ;~ msgbox % A_LoopFileName "`n" A_LoopFileExt
;~ }


f := FileOpen( "C:\Users\Deo\Desktop\transfer.gst", "r", "CP0" )
bufLen := f.RawRead( buf, f.Length )
b64Out := b64Encode( buf, bufLen )
msgbox % b64Out
f := FileOpen( "C:\Users\Deo\Desktop\stash_locked.gst", "r", "CP0" )
bufLen := f.RawRead( buf, f.Length )
b64Out := b64Encode( buf, bufLen )
msgbox % b64Out
;~ Examples:
